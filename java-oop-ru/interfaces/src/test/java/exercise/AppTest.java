...
class AppTest {
    ...
    void testReversedSequence1() {
        ReversedSequence rs = new ReversedSequence("asdf");
        String result = rs.toString();
        assertThat("fdsa").isEqualTo(result);
    }
    @Test
    void testReversedSequence2() {
        ReversedSequence rs = new ReversedSequence("asdf");
        char result = rs.charAt(1);
    ...
    void testReversedSequence4() {
        ReversedSequence rs = new ReversedSequence("abcdefgh");
        String result = rs.subSequence(1, 3).toString();
        assertThat("gf").isEqualTo(result);
    }
    // END
}
